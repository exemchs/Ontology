...
export function getGpuHealthIssues(): GpuHealthIssue[] {
  ...
  return [
    ...
    },
    {
      ...
      gpuName: "GPU-2",
      severity: "error",
      message: "GPU fan speed abnormal: running at 100% despite low load",
      timestamp: new Date(now.getTime() - 6.2 * 60 * 60 * 1000),
    },
    {
      id: 8,
      gpuName: "GPU-1",
      severity: "warning",
      message: "PCIe bandwidth degraded: 16 GB/s to 8 GB/s (Gen4 x8 fallback)",
      timestamp: new Date(now.getTime() - 7.0 * 60 * 60 * 1000),
    },
    {
      id: 9,
      gpuName: "GPU-3",
      severity: "warning",
      message: "Thermal throttling detected: clock reduced to 1200 MHz",
      timestamp: new Date(now.getTime() - 8.3 * 60 * 60 * 1000),
    },
    {
      id: 10,
      gpuName: "GPU-0",
      severity: "error",
      message: "XID error 79: GPU fallen off the bus — recovery attempted",
      timestamp: new Date(now.getTime() - 9.1 * 60 * 60 * 1000),
    },
    {
      id: 11,
      gpuName: "GPU-2",
      severity: "warning",
      message: "SM clock stuck at base frequency (210 MHz) for 15 min",
      timestamp: new Date(now.getTime() - 10.5 * 60 * 60 * 1000),
    },
    {
      id: 12,
      gpuName: "GPU-1",
      severity: "info",
      message: "CUDA compute capability check passed: sm_80",
      timestamp: new Date(now.getTime() - 11.0 * 60 * 60 * 1000),
    },
    {
      id: 13,
      gpuName: "GPU-3",
      severity: "warning",
      message: "Power draw spike detected: 295W (limit 300W) for 3 sec burst",
      timestamp: new Date(now.getTime() - 12.4 * 60 * 60 * 1000),
    },
    {
      id: 14,
      gpuName: "GPU-0",
      severity: "info",
      message: "MIG mode disabled — full GPU mode restored",
      timestamp: new Date(now.getTime() - 14.0 * 60 * 60 * 1000),
    },
    {
      id: 15,
      gpuName: "GPU-2",
      severity: "error",
      message: "Double-bit ECC error detected in HBM2e bank 3",
      timestamp: new Date(now.getTime() - 16.5 * 60 * 60 * 1000),
    },
    {
      id: 16,
      gpuName: "GPU-1",
      severity: "info",
      message: "NVLink peer-to-peer connectivity verified across all 4 GPUs",
      timestamp: new Date(now.getTime() - 18.0 * 60 * 60 * 1000),
    },
    {
      id: 17,
      gpuName: "GPU-3",
      severity: "warning",
      message: "GPU memory fragmentation high: 23% unusable (recommend restart)",
      timestamp: new Date(now.getTime() - 20.0 * 60 * 60 * 1000),
    },
    {
      id: 18,
      gpuName: "GPU-0",
      severity: "info",
      message: "Scheduled maintenance window completed — all checks passed",
